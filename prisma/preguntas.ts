export const ensayos = [
  {
    ...
    questions: [
      ...
      {
        question: "\\text{Si } {log_mlparen\\frac {8} {125}\\rparen = -3}, \\text{¿cual es el valor de m ?}",
        subject: "numeros",
      ...
      {
        question:
          "\\text{¿Cual de las siguientes cantidades corresponde al } {5}\\% \\text{ del precio de un articulo?}",
        subject: "numeros",
      ...
      {
        question:
          "\\text{Considera el númerop distinto de cero que es multiplicado dos veces por 1,25 y luego, dos veces por 0,75, tal como se representa a continuación: } {\\newline p \\cdot 1,25 \\cdot 1,25 \\cdot 0,75 \\cdot 0,75 \\newline} ¿Qué pueden representar dichas multiplicaciones, respecto del número original {p} ?",
        subject: "numeros",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "\\text{Si }{log_2{(-2x + 3p)} = 3}\\text{ y }{log_3{x +2p} = 1} \\text{¿Cual es el valor de x-2p?}",
        subject: "algebra",
      ...
      {
        question: "\\text{¿Cuáles son las soluciones de la ecuación }{x^{2} -12x +35 = 0}\\text{ ?}",
        subject: "algebra",
      ...
      },
      {
        ...
        answer: [
          ...
          {
            label: "\\text{Ignacio cobra un costo fijo de }{$(1,5 + 2500)}\\text{ a todos los productos que vende.}",
            right: 0,
          },
          {
            label:
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        // 16
        question:
          "\\text{En un curso, todos los alumnos participan de por lo menos una actividad deportiva, que puede ser futbol, atletismo o ambas. En el grupo de fútbol hay 32 alumnos del curso y en el grupo de atletismo hay 24 alumnos del curso, de los cuales la mitad pertenece además al grupo de fútbol. Al escoger un alumno al azar, ¿cuál es la probabilidad de que petenezca solamente al grupo de fútbol?}",
        subject: "probabilidades",
  ...
  },
  {
    ...
    questions: [
      {
        question:
          "\\text{Sean } {A(1,1)}, {B(5,3)} y {C} \\text{los vertices de un triangulo. Se pueden determinar las coordenadas del vertice } {C} \\text{ del triangulo si se sabe que: }  {(1)} \\text{ Angulo } {BAC = 90°} {(2)} \\text{El triangulo es isosceles y el vertice } {C} \\text{ esta en el cuarto cuadrante.}",
        subject: "geometria",
      ...
      {
        question:
          "\\text{Considere los vectores } {\\overrightarrow{u}} = {(-2,5)}, {\\overrightarrow{v}} = {(3, -2)} y {\\overrightarrow{c}} = {(-1,-4)}.\\newline \\text{¿Cual es el vector } {\\overrightarrow{u}} + 2{\\overrightarrow{v}} - {\\overrightarrow{c}}?",
        subject: "geometria",
      ...
      {
        question: "\\text{Con un cordel de largo d se forma un cuadrado. ¿Cuanto mide el area del un cuadrado ?}",
        subject: "geometria",
      ...
      {
        question:
          "\\text{Se necesita determinar el perímetro del rectángulo ABCD, cuyo largo y ancho miden} (4x por 1) cm y (x por 2) \\text{cm, respectivamente.} \\newline \\text{Se sabe que ABCD es semejante a un rectángulo cuyo largo y ancho miden 10 cm y 8cm, respectivamente.}{\\newline}\\text{Para determinar el perímetro del rectángulo ABCD se realiza el siguiente procedimiento, cometiéndose un error:} {\\newline} \\text{Paso 1: como los rectángulos son semejantes se plantea la expresión:} {\\frac{4x + 1}{8} = \\frac{x + 2}{10}\\newline} \\text{Paso 2: se resuelve la expresión anterior, obteniéndose} {x = \\fraac{3}{16} \\newline}\\text{Paso 3: se reemplaza este valor de x en} (4x  1) cm y (x  2) \\text{cm, obteniéndose que el largo y el ancho del rectángulo son } {\\frac{7}{4}}cm y {\\frac{35}{16}}cm, \\text{respectivamente.}{\\newline} \\text{Paso 4: se calcula el perímetro del rectángulo obteniéndose} {\\frac{63}{8}}cm.{\\newline} \\text{¿En cuál de los pasos se cometió el error?}",
        subject: "geometria",
      ...
      {
        question:
          "\\text{La razón de semejanza entre las figuras P y Q, en ese orden, es } {\\frac{3}{5}}, \\text{ mientras que la razón de semejanza entre las figuras R y P , en ese orden, es } {\\frac{7}{3} \\newline} \\text{¿Cuál es la razón de semejanza entre las figuras R y Q, en ese orden?}",
        subject: "geometria",
      ...
      {
        question:
          "\\text{Dentro de un sistema de coordenadas cartesianas se tienen los puntos A(2,3), B(5,8) y C(7,2). ¿Cuál es el área del triángulo ABC?}",
        subject: "geometria",
